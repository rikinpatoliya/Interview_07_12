...
object Prefs {
    ...
    operator fun set(key: String, value: Any?) =
        when (value) {
            ...
            else -> preferences.edit { it.putString(key, value.json) }
        }
    ...
    inline operator fun <reified T : Any> get(
     ...
     fun clearAll() = preferences.edit { it.clear().commit() }

    object Keys {
        const val IS_LOGGED_IN = "isLoggedIn"
//        const val IS_VALET_ID = "isValetId"
//        const val IS_VALET_NAME = "isValetName"
